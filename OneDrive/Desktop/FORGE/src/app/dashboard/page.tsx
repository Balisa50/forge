  ...
  return (
    <div>
      ...
      <div style={{ marginBottom: "2rem" }}>
        <h1 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "2.5rem", letterSpacing: "0.05em", marginBottom: "0.25rem" }}>
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        {[
          ...
          <div key={stat.label} className="forge-panel" style={{ padding: "1.25rem" }}>
            <div style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: "0.6875rem", color: "var(--text-dim)", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "0.5rem" }}>{stat.label}</div>
      ...
      {!checkedInToday && activeRoadmap && (
        ...
        >
          <div>
            <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.25rem", color: "var(--red)", letterSpacing: "0.05em" }}>⚠️ Check-in Required</div>
      ...
      {checkedInToday && (
        <div className="forge-panel" style={{ padding: "1.5rem", marginBottom: "2rem", borderColor: "var(--green)", background: "rgba(0,255,136,0.05)", display: "flex", alignItems: "center", gap: "1rem" }}>
          <span style={{ fontSize: "1.5rem" }}>✅</span>
          <div>
            <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.125rem", color: "var(--green)" }}>Today&apos;s Session Complete</div>
      ...
      {!activeRoadmap && (
        <div className="forge-panel" style={{ padding: "1.5rem", marginBottom: "2rem", borderColor: "var(--blue)", background: "rgba(0,200,255,0.05)", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem" }}>
          <div>
            <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.25rem", color: "var(--blue)" }}>No Active Roadmap</div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {activeRoadmap && (
          <div className="forge-panel" style={{ padding: "1.5rem" }}>
            <div className="flex items-center justify-between mb-4">
              <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.25rem", letterSpacing: "0.05em" }}>{activeRoadmap.title}</h2>
              <Link href="/dashboard/roadmap" style={{ color: "var(--blue)", fontSize: "0.8125rem", fontFamily: "'Share Tech Mono', monospace" }}>View All →</Link>
            </div>
              ...
              return (
                <div key={track.id} style={{ marginBottom: "1rem" }}>
                  <div className="flex justify-between items-center mb-1">
                    ...
                    <span style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: "0.75rem", color: "var(--text-dim)" }}>{doneTasks}/{totalTasks}</span>
                  </div>
        ...
        <div className="forge-panel" style={{ padding: "1.5rem" }}>
          <div className="flex items-center justify-between mb-4">
            <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.25rem", letterSpacing: "0.05em" }}>Recent Sessions</h2>
            <Link href="/dashboard/journal" style={{ color: "var(--blue)", fontSize: "0.8125rem", fontFamily: "'Share Tech Mono', monospace" }}>Journal →</Link>
          </div>
              ...
              {recentCheckins.slice(0, 5).map((c) => (
                <div key={c.id} className="flex items-center justify-between" style={{ padding: "0.5rem 0", borderBottom: "1px solid var(--border)" }}>
                  <div>
                    ...
                    <div style={{ color: "var(--text-dim)", fontSize: "0.75rem", fontFamily: "'Share Tech Mono', monospace" }}>{c.description.slice(0, 50)}...</div>
                  </div>
                  <div style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: "0.75rem", color: c.status === "passed" ? "var(--green)" : c.status === "failed" ? "var(--red)" : "var(--yellow)", textTransform: "uppercase" }}>
                    {c.status}
                  </div>
                </div>
              ))}
        ...
        {/* Integrity Log */}
        <div className="forge-panel" style={{ padding: "1.5rem" }}>
          <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "1.25rem", letterSpacing: "0.05em", marginBottom: "1rem" }}>Integrity</h2>
          <div className="flex items-end gap-4 mb-4">
            <div style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: "3.5rem", lineHeight: 1, color: badge.color }}>{integrity}</div>
            <div>
              <div style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: "0.75rem", color: badge.color, letterSpacing: "0.1em" }}>{badge.label}</div>
              <div style={{ fontFamily: "'Share Tech Mono', monospace", fontSize: "0.6875rem", color: "var(--text-dim)" }}>out of 100</div>
            </div>
          </div>
