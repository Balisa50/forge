export default function SettingsLoading() {
  return (
    <div style={{ maxWidth: "600px" }}>
      ...
      {[0, 1, 2].map((i) => (
        <div key={i} style={{ background: "var(--bg-panel)", border: "1px solid var(--border)", borderRadius: "10px", padding: "1.5rem", marginBottom: "1.5rem", animation: "shimmer 1.5s ease-in-out infinite", animationDelay: `${0.2 + i * 0.15}s` }}>
