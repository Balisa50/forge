...
const HOW_IT_WORKS = [
  ...
  { step: "02", title: "Get a real human mentor", desc: "Paired with a working professional who controls your week-by-week pace. They release each week with a personal note. They sign off when you've actually learned it — and they can suspend you if you go silent. Real accountability, not a progress bar." },
