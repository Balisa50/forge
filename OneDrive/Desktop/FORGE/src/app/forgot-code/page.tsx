        ...
        <div className="forge-panel" style={{ padding: "2rem" }}>
          {submitted ? (
            <div style={{ textAlign: "center" }}>
              ...
              <h1 style={{ fontFamily: "var(--font-headline)", fontSize: "1.5rem", marginBottom: "0.5rem" }}>Request sent</h1>
              <p style={{ color: "var(--text-secondary)", fontSize: "0.9375rem", lineHeight: 1.6, marginBottom: "1.5rem" }}>
                {mentorFirstName ?? "Your mentor"} will see your request on their dashboard and resend your Personal ID privately.
