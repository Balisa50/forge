...
const PLANS = [
  {
    ...
    features: [
      { text: "1 active roadmap", included: true },
      { text: "Daily AI interrogation (10 MCQ)", included: true },
      { text: "Integrity tracking", included: true },
      { text: "Journal & calendar", included: true },
      { text: "2 grace days/month", included: true },
      { text: "1 respite day/month", included: true },
      { text: "Basic analytics", included: true },
      { text: "AI roadmap generation", included: false },
      { text: "Project defence", included: false },
      { text: "PDF certificate", included: false },
  ...
  },
  {
    ...
    popular: true,
    features: [
      { text: "3 active roadmaps", included: true },
      { text: "Daily AI interrogation (10 MCQ)", included: true },
      { text: "Integrity tracking", included: true },
      { text: "Journal & calendar", included: true },
      { text: "4 grace days/month", included: true },
      { text: "3 respite days/month", included: true },
      { text: "Full analytics + radar chart", included: true },
      { text: "AI roadmap generation", included: true },
      { text: "Project defence (15 MCQ)", included: true },
      { text: "Verified PDF certificate", included: true },
      { text: "Priority AI models", included: false },
    ],
  },
  {
    ...
    features: [
      ...
      { text: "Integrity tracking", included: true },
      { text: "Journal & calendar", included: true },
      { text: "6 grace days/month", included: true },
      { text: "5 respite days/month", included: true },
      { text: "Full analytics + radar chart", included: true },
      { text: "AI roadmap generation", included: true },
      { text: "Project defence (15 MCQ)", included: true },
      { text: "Verified PDF certificate", included: true },
      { text: "Priority AI models (GPT-4o)", included: true },
    ],
  },
];
