 ...
 * heavy curriculum data out of the database during the migration phase, * the JSON is the source of truth, the DB later layers user progress on
 * top of it.
 */
 ...
 * the primer. The living simulation that makes the concept click, * e.g. a regression slider, a DataFrame inspector, a k-means stepper. */
